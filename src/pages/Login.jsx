...
const Login = () => {
  ...
  const { login, errors, sending, user, getUser, setErrors } = useAuthContext();
      ...
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 ">
            <div className="bg-black text-white relative mx-auto max-w-[525px] overflow-hidden rounded-lg py-16 px-10 text-center sm:px-12 md:px-[60px]">
